...
- `whitelist_usuarios`: control de acceso por correo y rol.
...
- `BASE DE DATOS ESCUELAS SLEP`: tabla maestra externa usada para establecimientos.
...
- La lectura de la tabla maestra de escuelas se hace con service role desde servidor.
