...
CREATE TABLE IF NOT EXISTS public.salidas_pedagogicas (
  ...
  distancia_ida_km DECIMAL(8, 2) NOT NULL DEFAULT 0,
  distancia_vuelta_km DECIMAL(8, 2) NOT NULL DEFAULT 0,
  duracion_minutos INTEGER NOT NULL,
  duracion_ida_minutos INTEGER NOT NULL DEFAULT 0,
  duracion_vuelta_minutos INTEGER NOT NULL DEFAULT 0,
  ruta_polyline TEXT NOT NULL,
  ruta_resumen TEXT NOT NULL,
  ruta_segmentos JSONB NOT NULL DEFAULT '[]',
